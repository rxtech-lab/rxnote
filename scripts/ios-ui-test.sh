...
# Runs UI tests for the RxNote iOS app

set -e  # Exit on error
set -o pipefail  # Catch errors in pipes

echo "======================================"
echo "RxNote iOS UI Test Script"
echo "======================================"
echo ""
...
if [ -f "$ENV_FILE" ]; then
    ...
    echo "  cp RxNote/.env.example RxNote/.env"
...
if [ $TEST_EXIT_CODE -eq 0 ]; then
    ...
    echo "3. Ensure RxNote/.env has TEST_EMAIL and TEST_PASSWORD set"
