#!/bin/bash
# Update OpenAPI spec for RxNoteCore iOS package
# Default: https://note.rxlab.app/api/openapi
...
TARGET_FILE="./RxNote/packages/RxNoteCore/Sources/RxNoteCore/openapi.json"
