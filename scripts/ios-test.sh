...
# Runs tests for the RxNote iOS app

set -e  # Exit on error
set -o pipefail  # Catch errors in pipes

echo "======================================"
echo "RxNote iOS Test Script"
echo "======================================"
echo ""
...
# The Xcode project only contains UI tests, not unit tests.
# Unit tests live in the Swift packages (RxNoteCore).
