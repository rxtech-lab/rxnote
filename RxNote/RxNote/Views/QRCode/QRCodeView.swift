...
struct QRCodeView: View {
    ...
    /// Basic initializer using only a URL string
    ...
    /// Initializer with note info for enhanced print layout
    init(urlString: String, noteTitle: String, noteContent: String?) {
        self.urlString = urlString
    ...
    var body: some View {
        ...
        .navigationTitle("QR Code")
            ...
            .sheet(isPresented: $showingPrintConfig) {
                if let title = noteTitle, let qrImage {
                    QRPrintConfigurationView(
                        noteTitle: title,
...
#Preview {
    NavigationStack {
        QRCodeView(urlString: "https://example.com/preview/note/1")
    }
}
