...
import SwiftUI
    ...
    struct QRPrintConfigurationView: View {
        ...
        init(noteTitle: String, noteContent: String?, qrImage: UIImage) {
            ...
            Section("Fields") {
                ForEach(configuration.fieldOrder) { field in
                    HStack {
                        ...
                        if configuration.fieldValue(for: field, title: noteTitle, note: noteContent) == nil {
                            Text("N/A")
                                .font(.caption)
        ...
        private func printQRCode() {
            ...
            printInfo.jobName = "QR Code - \(noteTitle)"
