...
struct SettingsView: View {
    ...
    var body: some View {
        List {
            ...
            Section("Support") {
                Button {
                    navigationManager.settingsNavigationPath.append(AppDestination.webPage(.helpAndSupport))
                } label: {
                    HStack {
                ...
                Button {
                    navigationManager.settingsNavigationPath.append(AppDestination.webPage(.privacyPolicy))
                } label: {
                    HStack {
                ...
                Button {
                    navigationManager.settingsNavigationPath.append(AppDestination.webPage(.termsOfService))
                } label: {
                    HStack {
            ...
            Section {
                ...
                if !accountDeletionViewModel.isPendingDeletion {
                    Text("Account deletion will be processed within 24 hours. All your notes and uploaded files will be permanently deleted.")
                }
            }
        ...
        .confirmationDialog(
            ...
            message:
            "Are you sure you want to delete your account? Your account will be scheduled for deletion in 24 hours. All your data including notes and uploaded files will be permanently deleted. You can cancel the deletion during the grace period.",
