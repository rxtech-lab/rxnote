...
@attached(body)
public macro APICall(_ successCase: SuccessCase) = #externalMacro(module: "RxNoteCoreMacros", type: "APICallMacro")

@attached(body)
public macro APICall(_ successCase: SuccessCase, transform: String) = #externalMacro(module: "RxNoteCoreMacros", type: "APICallMacro")
